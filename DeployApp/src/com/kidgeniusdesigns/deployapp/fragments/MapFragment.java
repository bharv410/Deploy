...
public class MapFragment extends Fragment
{
    ...
    /*
     * 
     * @Override public void onDestroyView() { super.onDestroyView(); if (mMap
     * != null) { EventHome.fragmentManager.beginTransaction()
     * .remove(EventHome.
     * fragmentManager.findFragmentById(R.id.location_map)).commit(); mMap =
     * null; } }
     */
}
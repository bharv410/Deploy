...
public class EditEventFrag extends Fragment
{
            ...
            ViewGroup container, Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(
                R.layout.edit_event_frag, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        editTitle = (EditText) getActivity().findViewById(
                R.id.editEventTitle);
        editTitle.setText(CreatorDetailsActivity.title);
        locationView = (EditText) getActivity().findViewById(
                R.id.locationTextView);
        locationView
                .setText(CreatorDetailsActivity.eventLocation);
        code = (EditText) getActivity().findViewById(
                R.id.editEventCode);
        code.setText(CreatorDetailsActivity.eventCode);
        editDescrip = (EditText) getActivity().findViewById(
